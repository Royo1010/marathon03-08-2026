...
Alleen week 38 en week 42 bevatten een extra korte **Fitness Check**. Die heet in de app `EXTRA FITNESS CHECK`, niet `Training 5`. Het schema wordt hierdoor niet structureel een vijfdaags loopschema.
...
**Vier reguliere trainingen:** ongeveer 48,83 km  
**Inclusief Extra Fitness Check #1:** exact berekend ongeveer 55,78 km  
**Let op:** de Fitness Check is een geplande extra korte prikkel, niet `Training 5`.
...
1. 5 min @ 9,2 km/u — 0,5%
2. 45 min @ 10,1 km/u — 0,5%
3. 5 min @ 8,5 km/u — 0,5%

**Totaal:** 55 min · ongeveer 9,05 km  
**Doel:** rustige omvang.  
**RPE:** 3–4/10.  
**Mentaal:** controle bewaren vóór de snelle training.

### Extra Fitness Check #1

**Labels:** `EXTRA FITNESS CHECK`, `TEST`  
...
**Weekafstand inclusief Extra Fitness Check #2:** exact berekend ongeveer 68,88 km  
**Let op:** dit zijn vier reguliere trainingen plus één gestandaardiseerde extra check.
...
1. 5 min @ 9,2 km/u — 0,5%
2. 50 min @ 10,2 km/u — 0,5%
3. 5 min @ 8,5 km/u — 0,5%

**Totaal:** 60 min · ongeveer 9,98 km  
**Doel:** rustige aerobe omvang.  
**RPE:** 3–4/10.  
**Mentaal:** fris genoeg blijven voor de kwaliteit en lange duur.

### Extra Fitness Check #2
...
**Reguliere weekafstand:** exact berekend ongeveer 53,65 km  
...
**Totaal:** 165 min · ongeveer 29,27 km; toon afgerond `±29,3 km`  
**Ondergrond:** loopband aanbevolen voor exacte controle van beide MP-blokken.  
**Doel:** testen of MP beheerst blijft nadat al 85 minuten is gelopen.  
**RPE:** tweede MP-blok idealiter maximaal ongeveer 7–7,5/10; techniek blijft goed; daarna normaal kunnen doorlopen.  
**Mentaal:** “Ik heb ruim 29 km gelopen en kon diep in de training tweemaal 30 minuten MP draaien.”  
...
- De extra checks krijgen eigen ID's, bijvoorbeeld `w38-fitness-check-1` en `w42-fitness-check-2`.
...
- [ ] Beide checks heten `EXTRA FITNESS CHECK`, niet `Training 5`.
...
- [ ] W42 is ongeveer 68,88 km inclusief Fitness Check #2.
...
- [ ] W44 bevat 2 × 30 min @ 12,0 km/u — 1% na 85 minuten voorafgaand lopen.
- [ ] W44 Training 4 is loopband aanbevolen.
- [ ] W44 is ongeveer 53,65 km.
